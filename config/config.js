var config = {
    ...
    welcome: "青青子衿，悠悠我心<br>" +
             "但为君故，沉吟至今<br>" +
             "茫茫人海，与你相遇，你好，我是张臣。<br>" +
             "很高兴见到你!",


    /*在这里配置关于我的信息，你可以内嵌HTML标签以调整格式*/
    about: "<p>我叫张臣，性别男，目前会津大学硕士在读。本科就读于河南理工大学。</p>" +
        "<p>我有着丰富的python编程经验，多线程，Tkinter，Django，Socket通信等十分熟悉，</p>" +
         "<p>精通latex，matlab等，计算机基础知识掌握扎实，目前研究网关安全，信息安全，物联网，元宇宙</p>"+
        "<p>十分期待与您的联系!</p>",
    ...
    */  
    ...
    skills_description: "<ul>" +
        ...
        "     <li>熟悉网关结构，熟知互联网通信原理。</li>" +
        "     <li>精通密码学和各种物联网攻击。</li>" +
        "     <li>了解各种机器学习和联邦学习等。</li>" +
        "     <li>熟悉元宇宙的基本架构和安全风险。</li>" +
        "     <li>了解物联网系统的拓扑结构，并可部署入侵检测系统。</li>" +
        "     <li>熟悉opencv实时图像识别与肢体语言识别等。opencv</li>" +
        "     <li>熟悉无接触式输入法的配置。</li>" +
        "     <li>熟悉缓存、消息等机制。</li>" +
        "     <li>了解HTML、CSS、JavaScript以及相应前端知识。</li>" +
        "     <li>英语级数为多邻国92分，对应英语四级460，雅思5.5分。</li>" +
        " </ul>",
    ...
    work: [
        ...
        ["2020/7/1 — 2021/8/10", "<br>一种改进的无线无源目标定位稀疏编码算法",
            "<p><strong>简要介绍</strong></p>" +
            "<p>随着智慧城市的发展，无需携带任何设备即可检测目标的无线无源定位（WPL）技术引起了广泛的研究关注，我们提出了改进的稀疏编码算法即使在具有挑战性的环境中也能以稳健的性能准确定位目标。</p>"
        ],

        ["2020/7/1 — 2021/8/10", "<br>PCIDS：一种在网关上的基于权限和可信度的入侵检测系统",
            "<p><strong>简要介绍</strong></p>" +
            "<p>物联网设备的易访问性导致了物联网现在面临前所未有的安全挑战。本文通过统计流量特征和身份认证，建立了DoS、Replay、MITM攻击和漏洞攻击的威胁模型，并利用监督学习获取可信度指标，以保护物联网系统</p>" 
        ]
    ],
